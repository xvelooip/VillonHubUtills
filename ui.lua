...
if getcustomasset then
	...
	pcall(function()
		if not isfile(dir..'/'..'logo.png') then
			local byte = game:HttpGet('https://raw.githubusercontent.com/xvelooip/VillonHubUtills/main/logous.png');
	...
	if not isfile(dir..'/'..'saturation_value_gradient.png') then
		local byte = game:HttpGet('https://raw.githubusercontent.com/xvelooip/VillonHubUtills/main/saturation_value_gradient.png');
