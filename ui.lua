...
if getcustomasset then
	...
	pcall(function()
		if not isfile(dir..'/'..'logous.png') then
			local byte = game:HttpGet('https://raw.githubusercontent.com/xvelooip/VillonHubUtills/refs/heads/main/logous.png');
			writefile(dir..'/'..'logous.png', byte);
			task.wait();
		end;
		if isfile(dir..'/'..'logous.png') then
			NeverLose.GlobalLogo = getcustomasset(dir..'/'..'logous.png')
		end;
	end);
	pcall(function()
		if not isfile(dir..'/'..'saturation_value_gradient.png') then
			local byte = game:HttpGet('https://raw.githubusercontent.com/xvelooip/VillonHubUtills/refs/heads/main/saturation_value_gradient.png');
